...
\hyphenation{mię-dzy-na-ro-do-wych}
\hyphenation{spo-łecz-nej}
\hyphenation{na-u-ko-wo-ba-daw-czych}
\hyphenation{sto-wa-rzy-sze-nia}
\hyphenation{sto-wa-rzy-sze-niu}
\hyphenation{tak-że}
\hyphenation{człon-ków}
\hyphenation{mie-się-cy}
\hyphenation{nie-ma-jąt-ko-wych}
\hyphenation{mu-szą}
\hyphenation{zwo-ła-ne}
\hyphenation{prze-ka-za-ny}
